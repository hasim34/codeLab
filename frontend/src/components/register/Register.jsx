...
// import "./Register.css";
// // import codelabLogo from "./codelabLogo.png"; // uncomment if you have a logo
// // import { useNavigate } from "react-router-dom";
...
//         "Register number must be 11 digits and contain only numbers.";
...
//         />
//         <h2>Join the Community</h2>
//         <p>Start your coding journey with thousands of students.</p>
//       </div>
...
//               <p className="error-message">{errors.registerNumber}</p>
//             )}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/auth/register`, {
        ...
        email: formData.email,
        phone: formData.phone,
        roll_number: formData.registerNumber,
      ...
      console.error(err);
      setErrors({ apiError: err.response?.data?.message || "Server error" });
    }
  };
